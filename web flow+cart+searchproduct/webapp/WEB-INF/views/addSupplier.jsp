...
<br><br><br>
		...
		<form:form action="${pageContext.request.contextPath}/admin/supplier/add" commandName="suppliercommand">
			<table>
				...
				<tr>
					<td>Supplier Name</td>
					<td><form:input path="supname" id="supname" /></td>
				...
				<tr>
					...
					<td><form:errors path="supnumber">supnumber</form:errors></td>
				</tr>
				<tr>
					<td>Email</td>
				...
				<tr>
					<td colspan="2"><c:if test="${!empty suppliercommand.sid}">
				...
				<tbody>
					<c:forEach var="sup" items="${supplier}">
						<tr>
							...
							<td><a href="<c:url value="/admin/supplier/edit/${sup.sid}" />">Edit</a></td>
							<td><a href="<c:url value="/admin/supplier/remove/${sup.sid}" />">Delete</a></td>
						</tr>
					</c:forEach>
				</tbody>
			</table>
