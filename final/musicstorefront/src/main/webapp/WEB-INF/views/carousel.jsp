...
<body>
	...
	<div class="row" id="features">
		...
		<a class="btn btn-default" href="<c:url value="/productList?searchCondition=Tabla" />" role="button">
			<img src="<c:url value="resources/images/tabla.png" />" alt="
				MusicHub" class="img-circle"></a>
			<h3>Tabla</h3>
		</div>
		<!-- end col-sm-4 -->

		<div class="col-sm-4 feature" id="middle-slide">
		<a class="btn btn-default" href="<c:url value="/productList?searchCondition=Sitar" />" role="button">
		...
		<a class="btn btn-default" href="<c:url value="/productList?searchCondition=Flute" />" role="button">
