...
<div class="container-wrapper">
    <div class="container">
        ...
        <div class="form-group">
            ...
            <form:input path="cart.users.username" id="name" class="form-Control" />
        </div>

        <div class="form-group">
            <label for="email">Email</label>
            <form:input path="cart.users.useremail" id="email" class="form-Control" />
        </div>

        <div class="form-group">
            <label for="phone">Phone</label>
            <form:input path="cart.users.usernumber" id="phone" class="form-Control" />
        </div>
        ...
        <div class="form-group">
            ...
            <form:input path="cart.users.billingAddress.houseNumber" id="billingApartmentNumber" class="form-Control" />
        </div>
