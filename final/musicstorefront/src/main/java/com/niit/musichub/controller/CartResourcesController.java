...
public class CartResourcesController {
    ...
    public void addItem (@PathVariable(value = "pid") String pid, Principal p){
    ...
    @ResponseStatus(value = HttpStatus.NO_CONTENT)
    public void removeItem(@PathVariable(value = "pid") String pid){
        CartItem cartItem = (CartItem) cartItemService.getCartItemByProductId(pid);
        System.out.println("dsafbghnvhgafgghbvgfghbjghj");
