...
<img src=<c:url value="resources/images/bg1.png"/>"/>
				...
				<tbody>
					<c:forEach var="cat" items="${category}">
						<tr>
							...
							<td>${cat.stock}</td>
							<td><a href="<c:url value="/admin/category/edit/${cat.cid}" />"><span class="glyphicon glyphicon-pencil">Edit</span></a></td>
							<td><a href="<c:url value="/admin/category/remove/${cat.cid}" />"><span class="glyphicon glyphicon-trash">Delete</span></a></td>
						</tr>
					</c:forEach>
				</tbody>
			</table>
