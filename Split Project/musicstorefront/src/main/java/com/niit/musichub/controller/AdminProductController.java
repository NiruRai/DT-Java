...
public class AdminProductController {
	...
	public String listProducts(Model model) {
		...
		model.addAttribute("productList", this.pdi.list());
		model.addAttribute("categoryList", this.cse.list());
		model.addAttribute("supplierList", this.sse.list());
		return "allCategory";
	}
	...
	public String addProduct(@ModelAttribute("productcommand") Product p, HttpServletRequest request,
		...
		Category category= cse.getByName(p.getCategory().getCname());
		cse.saveOrUpdate(category);
		Supplier supplier=sse.getByName(p.getSupplier().getSupname());
	...
	public String plistProducts(Model model) {
		model.addAttribute("product", new Product());
		model.addAttribute("category", new Category());
		model.addAttribute("supplier", new Supplier());
		model.addAttribute("productList", this.pdi.list());
