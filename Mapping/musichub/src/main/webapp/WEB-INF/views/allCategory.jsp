	...
	background-color: #ffffff;
		...
		<form:form action="${pageContext.request.contextPath}/admin/product/add" commandName="productcommand"
			...
			<table>
				...
				<tr>
					<td colspan="2"><c:if test="${!empty productcommand.pid}">
				...
				<tbody>
					<c:forEach var="pro" items="${product}">
						<tr>
							...
							<td><a href="<c:url value="/admin/product/edit/${pro.pid}" />">Edit</a></td>
							<td><a href="<c:url value="/admin/product/remove/${pro.pid}" />">Delete</a></td>
						</tr>
					</c:forEach>
				</tbody>
			</table>
